...
#        Key([], 'w', lazy.group['guiApps'].dropdown_toggle('zap')),
        ],
             name="󰊠"
             ),
    KeyChord([mod], 'w', [ 
                          ...
                          Key([], 'r', lazy.group[groups[2].name].toscreen()),
                          Key([], 'e', lazy.group[groups[3].name].toscreen()),
                          Key([], 't', lazy.group[groups[4].name].toscreen()),
                          Key([], 'g', lazy.group[groups[5].name].toscreen()),
                          Key([], 'm', lazy.group[groups[6].name].toscreen()),
                          ],
             name=""
             ),
    KeyChord([mod, 'shift'], 'w', [ 
                                   ...
                                   Key([], 'r',  lazy.window.togroup(groups[2].name)),
                                   Key([], 'e',  lazy.window.togroup(groups[3].name)),
                                   Key([], 't',  lazy.window.togroup(groups[4].name)),
                                   Key([], 'g',  lazy.window.togroup(groups[5].name)),
                                   Key([], 'm',  lazy.window.togroup(groups[6].name)),
                                   ],
             name=""
             ),
