...
struct Pertag {
	...
	int nmasters[6 + 1]; /* number of windows in master area */
	float mfacts[6 + 1]; /* mfacts per tag */
	unsigned int sellts[6 + 1]; /* selected layouts */
	const Layout *ltidxs[6 + 1][2]; /* matrix of tags and layouts indexes  */
};
